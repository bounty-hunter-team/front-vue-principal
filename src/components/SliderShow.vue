    ...
    <div class="slides-container">
      <div class="slide">
        ...
        <div class="slide-content">
          <span
            >En América Latina, se registran cientos de miles de personas
            desaparecidas.</span
          ><br />
          <span>A causa de los conflictos armados del pasado y presente.</span>
          <a
            class="button"
      ...
      <div class="slide">
        ...
        <div class="slide-content">
          <span>
            Se estima que en las dos últimas décadas han desaparecido 200.000
            personas...
          </span>
          <br />
          <span>pero podrían ser muchas más.</span>
          <a class="button" href="https://unsplash.com/@madbyte" target="/black"
            >Unsplash Profile</a
          >
        </div>
      </div>
